...
window.addEventListener("DOMContentLoaded", function () {
  ...
  var forms = new _modules_Form__WEBPACK_IMPORTED_MODULE_4__["default"](".form");
  forms.init();
});
    ...
    value: function init() {
      ...
      this.forms.forEach(function (form) {
        form.addEventListener("submit", function (e) {
          ...
          statusElement.textContent = _this.message.loading;
          var formData = new FormData(form);

          _this.postData(_this.path, formData).then(function (res) {
            console.log(res);
            statusElement.textContent = _this.message.success;
          }).catch(function () {
            statusElement.textContent = _this.message.error;
          });
        });
      });
    }
